...
let surveyGirlLast = [
    {
      id:0,
      questions2: 'What is one activity that you would like to do on a date? ',
      b1: 'Try out a new cafe',
      b2: 'Head to the zoo',
      b3: 'Go on a picnic',
      b4: 'Attend a Concert'
    },
...
function QuestionScreen20E({navigation}) {
      ...
      <View style={styles.questionBorder3}>
            <View style={styles.questionBorder2}>
              <View style={styles.questionBorder1}>
                  ...
                  <TouchableOpacity style={styles.buttonChoices} onPress={() => navigation.navigate('ResponseScreen20E') } >
...
export default QuestionScreen20E;