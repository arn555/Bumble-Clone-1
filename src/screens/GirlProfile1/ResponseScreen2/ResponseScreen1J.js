...
function ResponseScreen1J({navigation}) {
        ...
        <View style={styles.responseBorder3}>
          <View style={styles.responseBorder2}>
              <View style={styles.responseBorder1}>
                  <Text style={styles.responseText}>I love that too!</Text>
              </View>
          </View>
        </View>
          ...
          <TouchableOpacity style={styles.responseButton} onPress={() => navigation.navigate('QuestionScreen20F')}>
...
export default ResponseScreen1J;