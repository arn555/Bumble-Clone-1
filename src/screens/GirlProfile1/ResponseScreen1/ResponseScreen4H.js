...
let responseGirlOne = [
  {
    ...
    a4: `That's Fine. Maybe we could work on that.`,
    
  },
  
];

function ResponseScreen4H({navigation}) {
        ...
        <View style={styles.responseBorder3}>
          <View style={styles.responseBorder2}>
              <View style={styles.responseBorder1}>
                  <Text style={styles.responseText}>{item.a4}</Text>
              </View>
          </View>
        </View>
...
export default ResponseScreen4H;